  ...
  const result: ResultType = {
    ...
    activity: {
      ...
      activity: {
        ...
        independentChoiceCount: (save.flags as Record<string, unknown>)['activity_independent_choices'] as number ?? 0,
        communityBeatCount: (save.flags as Record<string, unknown>)['activity_community_beats'] as number ?? 0,
